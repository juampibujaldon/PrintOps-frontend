...
const styles = StyleSheet.create({
  ...
  skeletonDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: Colors.separator, marginRight: Spacing.sm, marginTop: 4 },
  skeletonCard: {
    flex: 1,
  ...
  skeletonBar: { height: 12, backgroundColor: Colors.background, borderRadius: Radius.sm, marginBottom: Spacing.sm },
});
